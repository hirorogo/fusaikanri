...
- **[ローカル環境でのセットアップ](./SETUP.md)** - 開発環境での構築方法
- **[VPSでのセットアップ](./VPS_SETUP.md)** - VPS上で24時間稼働させる方法（本番環境推奨）
...
- `/debt pay_on_behalf <債務者> <債権者> <金額>` - 他の人の借金を代わりに返済する
...
# 他の人の借金を代わりに返済
/debt pay_on_behalf @債務者 @債権者 1000
...
サマリー機能を使うと、サーバー全体の借金状況を一目で確認できます。
...
- 総借金額: サーバー全体の借金総額
- 関係者数: 借金に関わっている人数
- トップ債権者: 貸している金額が多い上位5人
- トップ債務者: 借りている金額が多い上位5人
...
代理返済機能を使うと、他の人の借金を代わりに返済したことを記録できます。
...
```
/debt pay_on_behalf @Bさん @Cさん 1000
```

**結果:**
- Cさん → Bさんへの債権: 3000円 → 2000円

**ログ例:**
```
@Aさんが@Bさんの代わりに@Cさんへ1000円返済した！
残りの借金は2000円だぞ！
```

**完済時のログ:**
```
@Aさんが@Bさんの代わりに@Cさんへ3000円返済した！
完済だ！おつかれ！
```
