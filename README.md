...
- `/debt pay_on_behalf <債務者> <債権者> <金額>` - 他の人の借金を代わりに返済
...
# 他の人の借金を代わりに返済
/debt pay_on_behalf @債務者 @債権者 500
...
代理返済機能を使うと、第三者が他のユーザーの借金を代わりに返済できます。
...
```
/debt pay_on_behalf @Bさん @Aさん 2000
```

**結果:**
- Aさん → Bさんへの借金: 5000円 → 3000円
- CさんがBさんの代わりに返済した記録が残る

**ログ例:**
```
@Cさんが@Bさんの代わりに@Aさんに2000円返済した！
@Bさんの残りの借金は3000円だぞ！
```
...
- 2026-01-06: 初回リリース
- 2026-01-06: 代理返済機能（pay_on_behalf）を追加